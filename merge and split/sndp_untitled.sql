...
CREATE OR REPLACE FUNCTION "public"."merge_split_storage"("storage_action" varchar, "parent_ids" int[], "child_array" json, 
...
FOR child IN SELECT * FROM json_array_elements(child_array) LOOP
    SELECT * FROM "public".add_storage(child::json) INTO return_result;
